			...
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">Rs.1,54,232</strong>
						<span className="text-sm text-green-500 pl-2">+54,000</span>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">Rs.54,000</strong>
						<span className="text-sm text-green-500 pl-2">+1,000</span>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">2,313</strong>
